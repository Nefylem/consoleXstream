...
{
    public class classControllerMax
    {
        ...
        public classControllerMax(Form1 mainForm) { frmMain = mainForm; }
        ...
        public void getKeyboardInterfaceHandle(classKeyboardInterface inKeyInterface)
        {
