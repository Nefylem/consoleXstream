...
namespace consoleXstream
{
    public class classSystem
    {
        ...
        {
            public string strDpadDown { get; set; }
            public string strDpadUp { get; set; }
            public string strDpadLeft { get; set; }
            public string strDpadRight { get; set; }

            public string strButtonA { get; set; }
            public string strButtonB { get; set; }
            public string strButtonX { get; set; }
            public string strButtonY { get; set; }

            public string strLXleft { get; set; }
            public string strLXright { get; set; }
            public string strLYup { get; set; }
            public string strLYdown { get; set; }

            public string strRXleft { get; set; }
            public string strRXright { get; set; }
            public string strRYup { get; set; }
            public string strRYdown { get; set; }

            public string strModifier { get; set; }
            public string strRightModifier { get; set; }

            public string strButtonBack { get; set; }
            public string strButtonStart { get; set; }
            public string strButtonHome { get; set; }
        }
        ...
        public classSystem(Form1 mainForm) { frmMain = mainForm; }
        ...
        public void getVideoResolutionHandle(classVideoResolution inVid) { videoResolution = inVid; }
        ...
        public void initializeKeyboardDefaults()
        {
            ...
            keyDef.strDpadDown = "DOWN";
            keyDef.strDpadUp = "UP";
            keyDef.strDpadLeft = "LEFT";
            keyDef.strDpadRight = "RIGHT";

            keyDef.strButtonY = "KEY_I";
            keyDef.strButtonX = "KEY_J";
            keyDef.strButtonA = "KEY_K";
            keyDef.strButtonB = "KEY_L";
            
            keyDef.strLXleft = "KEY_A";
            keyDef.strLXright = "KEY_D";
            keyDef.strLYup = "KEY_W";
            keyDef.strLYdown = "KEY_S";

            keyDef.strRXleft = "NUMPAD4";
            keyDef.strRXright = "NUMPAD6";
            keyDef.strRYup = "NUMPAD8";
            keyDef.strRYdown = "NUMPAD2";

            keyDef.strModifier = "LSHIFT";
            keyDef.strRightModifier = "RSHIFT";

            keyDef.strButtonBack = "ESCAPE";
            keyDef.strButtonHome = "F2";
            keyDef.strButtonStart = "F3";
            keyAltDef.strButtonBack = "F4";

            keyAltDef.strButtonA = "RETURN";
            keyAltDef.strButtonB = "BACK";
        }
