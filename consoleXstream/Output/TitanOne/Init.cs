...
namespace consoleXstream.Output.TitanOne
{
    class Init
    {
        ...
        {
            _class.BaseClass.System.Debug("titanOne.log", "[0] Opening TitanOne api");
            ...
            {
                _class.BaseClass.System.Debug("titanOne.log", "[0] [FAIL] Unable to find TitanOne API (gcdapi.dll)");
                return;
            }
            ...
            if (ptrLoad == IntPtr.Zero) { _class.BaseClass.System.Debug("titanOne.log", "[0] [FAIL] gcapi_Load"); return; }

            var ptrLoadDevice = LoadExternalFunction(ptrDll, "gcdapi_LoadDevice");
            if (ptrLoadDevice == IntPtr.Zero) { _class.BaseClass.System.Debug("titanOne.log", "[0] [FAIL] gcapi_LoadDevice"); return; }

            var ptrIsConnected = LoadExternalFunction(ptrDll, "gcapi_IsConnected");
            if (ptrIsConnected == IntPtr.Zero) { _class.BaseClass.System.Debug("titanOne.log", "[0] [FAIL] gcapi_IsConnected"); return; }

            var ptrUnload = LoadExternalFunction(ptrDll, "gcdapi_Unload");
            if (ptrUnload == IntPtr.Zero) { _class.BaseClass.System.Debug("titanOne.log", "[0] [FAIL] gcapi_Unload"); return; }

            var ptrGetTimeVal = LoadExternalFunction(ptrDll, "gcapi_GetTimeVal");
            if (ptrGetTimeVal == IntPtr.Zero) { _class.BaseClass.System.Debug("titanOne.log", "[0] [FAIL] gcapi_GetTimeVal"); return; }

            var ptrGetFwVer = LoadExternalFunction(ptrDll, "gcapi_GetFWVer");
            if (ptrGetFwVer == IntPtr.Zero) { _class.BaseClass.System.Debug("titanOne.log", "[0] [FAIL] gcapi_GetFWVer"); return; }
            ...
            if (ptrRead == IntPtr.Zero) { _class.BaseClass.System.Debug("titanOne.log", "[0] [FAIL] gcapi_WriteEX"); return; }

            var ptrWriteEx = LoadExternalFunction(ptrDll, "gcapi_WriteEX");
            if (ptrWriteEx == IntPtr.Zero) { _class.BaseClass.System.Debug("titanOne.log", "[0] [FAIL] gcapi_WriteEX"); return; }

            var ptrReadEx = LoadExternalFunction(ptrDll, "gcapi_ReadEX");
            if (ptrReadEx == IntPtr.Zero) { _class.BaseClass.System.Debug("titanOne.log", "[0] [FAIL] gcapi_ReadEX"); return; }

            var ptrCalcPressTime = LoadExternalFunction(ptrDll, "gcapi_CalcPressTime");
            if (ptrCalcPressTime == IntPtr.Zero) { _class.BaseClass.System.Debug("titanOne.log", "[0] [FAIL] gcapi_CalcPressTime"); return; }

            try
            {
                _class.BaseClass.System.Debug("titanOne.log", "[5] Marshal _gcapi_Load");
                _class.Define.Load = (Define.GcapiLoad)Marshal.GetDelegateForFunctionPointer(ptrLoad, typeof(Define.GcapiLoad));

                _class.BaseClass.System.Debug("titanOne.log", "[5] Marshal _gcapi_LoadDevice");
                ...
                _class.BaseClass.System.Debug("titanOne.log", "[5] Marshal _gcapi_IsConnected");
                ...
                _class.BaseClass.System.Debug("titanOne.log", "[5] Marshal _gcapi_Unload");
                _class.Define.Unload = (Define.GcapiUnload)Marshal.GetDelegateForFunctionPointer(ptrUnload, typeof(Define.GcapiUnload));

                _class.BaseClass.System.Debug("titanOne.log", "[5] Marshal _gcapi_GetTimeVal");
                ...
                _class.BaseClass.System.Debug("titanOne.log", "[5] Marshal _gcapi_GetFwVer");
                ...
                _class.BaseClass.System.Debug("titanOne.log", "[5] Marshal _gcapi_Write");
                _class.Define.Write = (Define.GcapiWrite)Marshal.GetDelegateForFunctionPointer(ptrWrite, typeof(Define.GcapiWrite));

                _class.BaseClass.System.Debug("titanOne.log", "[5] Marshal _gcapi_CalcPressTime");
            ...
            _class.BaseClass.System.Debug("titanOne.log", ">>>" + _class.Write.DevId);
            if (_class.Define.LoadDevice((ushort)_class.Write.DevId) == 1)
                _class.BaseClass.System.Debug("titanOne.log", "[0] Initialize TitanOne GCAPI ok");
            else
            {
                _class.BaseClass.System.Debug("titanOne.log", "[0] Initialize TitanOne failed");
                return;
            }
        ...
        private void CloseSingle()
        {
            ...
            _class.BaseClass.System.Debug("titanOne.log", "[OK] Closed TitanOne API");
        }
    }
}
