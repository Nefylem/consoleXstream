...
namespace consoleXstream
{
    public class classTitanOne
    {
        ...
        public classTitanOne(Form1 mainForm) { frmMain = mainForm; }
        public void getSystemHandle(classSystem inSystem) { system = inSystem; }
        public void getKeyboardInterfaceHandle(classKeyboardInterface inKeyInterface) { keyboardInterface = inKeyInterface; }
