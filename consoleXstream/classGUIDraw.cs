...
namespace consoleXstream
{
    class classGUIDraw
    {
        ...
        private Color _colorFontMinor = Color.White;
        private Color _colOutline = Color.Black;

        private Brush _fontBrush = Brushes.Black;
        private string _strFontName = "Tahoma";

        private float _floatFontSize = 12;
        private int _intOutlineSize = 4;
        ...
        private List<OutlineText> _listOutline = new List<OutlineText>(); 


        //Passes in a bitmap to clear the graph. Gets x & y from bitmap size, assigns passed image as background
        ...
        public void centerText(Rectangle newRect, string strWrite)
        {
            ...
            Font fontSet = new Font(_strFontName, _floatFontSize, FontStyle.Bold, GraphicsUnit.Pixel);
        ...
        public void drawText(int intX, int intY, string strWrite)
        {
            ...
            SizeF textSize = _graph.MeasureString(strWrite, new Font(_strFontName, _floatFontSize));
            ...
            _graph.DrawString(strWrite, new Font(_strFontName, _floatFontSize), _fontBrush, textRect);
        }
        ...
        private void outlineText(int intX, int intY, string strWrite)
        {
            ...
            {                
                for (int intCount = 0; intCount < _listOutline.Count; intCount++)
                {
                    ...
                    if (_listOutline[intCount].strFontName != _strFontName) boolFound = false;
            ...
            Pen penOutline = new Pen(_colOutline, _intOutlineSize);
            ...
            _listOutline[intIndex].strFontName = _strFontName;
        ...
        public void drawTextJustify(Bitmap bmpSource, Rectangle newRect, string strWrite)
        {
            ...
            _graph.DrawString(strWrite, new Font(_strFontName, _floatFontSize), _fontBrush, checkRect, setFormat);
        }
