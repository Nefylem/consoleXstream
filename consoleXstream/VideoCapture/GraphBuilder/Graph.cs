    ...
    public class GraphMap
    {
        ...
        public bool BuildGraph()
        {
            ...
            if (_class.Capture.CurrentDevice > -1 && _class.Capture.CurrentDevice < _class.Var.VideoCaptureDevice.Count)
            {
                ...
                IBaseFilter pCaptureDevice = _class.GraphFilter.Set(FilterCategory.VideoInputDevice, strVideoDevice, out strTempOut);
                _class.Debug.Log("");
                ...
                strCaptureAudioOut = _class.GraphPin.AssumePinOut("Audio");

                strCaptureVideoIn = _class.GraphPin.AssumePinIn("Video");
                if (strCaptureVideoIn.Length == 0) strCaptureVideoIn = _class.GraphPin.AssumePinIn("Capturar", "vídeo");

                strCaptureAudioIn = _class.GraphPin.AssumePinIn("Audio");
                ...
                if (_class.Audio.Output > -1 && _class.Audio.Output < _class.Audio.Devices.Count)
                {
                    ...
                    if (pAudio != null)
                    {
                        ...
                        strAudioIn = _class.GraphPin.AssumePinIn("Audio");
